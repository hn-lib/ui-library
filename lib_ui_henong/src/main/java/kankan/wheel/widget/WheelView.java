...
public class WheelView extends View {
    ...
    // Scrolling
    private kankan.wheel.widget.WheelScroller scroller;
...
//        centerDrawable.draw(canvas);
        ...
        // �����߿�
        paint.setStrokeWidth((float) dp2px(2));
        // �����ϱ�ֱ��
        canvas.drawLine(dp2px(15), center - offset, getWidth() - dp2px(15), center - offset, paint);
        // �����±�ֱ��
        canvas.drawLine(dp2px(15), center + offset, getWidth() - dp2px(15), center + offset, paint);
