package com.henong.dialog.base;
...
public abstract class BaseAlertDialog<T extends BaseAlertDialog<T>> extends BaseDialog {
     ...
     * btn textsize(按钮字体大小)
     */
    protected float leftBtnTextSize_SP = 17f;
    protected float rightBtnTextSize_SP = 17f;
    protected float middleBtnTextSize_SP = 17f;
    /**
     * btn press color(按钮点击颜色)
     */
    protected int btnPressColor = Color.parseColor("#E3E3E3");// #85D3EF,#ffcccccc,#E3E3E3
    protected int btnPressColorOrange = Color.parseColor("#cf4d0b");
    /**
     * left btn click listener(左按钮接口)
     */
    protected com.henong.dialog.listener.OnClickListener onBtnLeftClickListener;
    /**
     * right btn click listener(右按钮接口)
     */
    protected com.henong.dialog.listener.OnClickListener onBtnRightClickListener;
    /**
     * middle btn click listener(右按钮接口)
     */
    protected com.henong.dialog.listener.OnClickListener onBtnMiddleClickListener;
    ...
    protected int btnBgColor = Color.parseColor("#f0f0f0");
    protected int btnBgColorOrange = Color.parseColor("#fc6a21");
    ...
    public void setUIBeforeShow() {
        ...
        tv_btn_left.setTypeface(null, Typeface.BOLD);
        tv_btn_right.setTypeface(null, Typeface.BOLD);
        tv_btn_middle.setTypeface(null, Typeface.BOLD);
        ...
        tv_btn_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (onBtnLeftClickListener != null) {
                    onBtnLeftClickListener.onClick();
                } else {
                    dismiss();
                }
            }
        ...
        tv_btn_right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (onBtnRightClickListener != null) {
                    onBtnRightClickListener.onClick();
                } else {
                    dismiss();
                }
            }
        ...
        tv_btn_middle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (onBtnMiddleClickListener != null) {
                    onBtnMiddleClickListener.onClick();
                } else {
                    dismiss();
                }
            }
     ...
     */
    public T setTitleTextSize(float titleTextSize_SP) {
     ...
     */
    public T setContentTextSize(float contentTextSize_SP) {
     ...
     */
    public T setCornerRadius(float cornerRadius_DP) {
     ...
     * onClickListeners size 1, middle
     * onClickListeners size 2, left right
     * onClickListeners size 3, left right middle
     */
    public void setOnBtnClickL(com.henong.dialog.listener.OnClickListener... onClickListeners) {
        if (onClickListeners.length < 1 || onClickListeners.length > 3) {
            throw new IllegalStateException(" range of param onClickListeners length is [1,3]!");
        }

        if (onClickListeners.length == 1) {
            this.onBtnMiddleClickListener = onClickListeners[0];
        } else if (onClickListeners.length == 2) {
            this.onBtnLeftClickListener = onClickListeners[0];
            this.onBtnRightClickListener = onClickListeners[1];
        } else if (onClickListeners.length == 3) {
            this.onBtnRightClickListener = onClickListeners[0];
            this.onBtnRightClickListener = onClickListeners[1];
            this.onBtnMiddleClickListener = onClickListeners[2];
        }
    }

    /**
     * set right btn click callback
     *
     * @param onBtnLeftClickL
     * @param btnStr          按钮文本
     */
    public void setPositiveButton(String btnStr, com.henong.dialog.listener.OnClickListener onBtnLeftClickL) {
        this.btnRightText = btnStr;
        tv_btn_right.setText(btnRightText);
        this.onBtnRightClickListener = onBtnLeftClickL;
    }

    /**
     * set left btn click callback
     *
     * @param onBtnLeftClickL
     * @param btnStr          按钮文本
     */
    public void setNegativeButton(String btnStr, com.henong.dialog.listener.OnClickListener onBtnLeftClickL) {
        this.btnLeftText = btnStr;
        tv_btn_left.setText(btnLeftText);
        this.onBtnLeftClickListener = onBtnLeftClickL;
    }

    /**
     * set middle btn click callback
     *
     * @param onBtnLeftClickL
     * @param btnStr          按钮文本
     */
    public void setNeutralButton(String btnStr, com.henong.dialog.listener.OnClickListener onBtnLeftClickL) {
        this.btnMiddleText = btnStr;
        tv_btn_middle.setText(btnMiddleText);
        this.onBtnMiddleClickListener = onBtnLeftClickL;
    }
