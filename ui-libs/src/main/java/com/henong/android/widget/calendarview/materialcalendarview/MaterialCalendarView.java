package com.henong.android.widget.calendarview.materialcalendarview;
...
import com.henong.android.widget.calendarview.materialcalendarview.format.MonthArrayTitleFormatter;
import com.henong.android.widget.calendarview.materialcalendarview.format.TitleFormatter;
import com.henong.android.widget.calendarview.materialcalendarview.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            setSelectionColor(
                    a.getColor(R.styleable.MaterialCalendarView_mcv_selectionColor,
    ...
    private void setupChildren() {
        ...
        topbar.setBackgroundColor(Color.parseColor("#ff8200"));
...
//        final int desiredHeight = specHeightSize - getPaddingTop() - getPaddingBottom();
        final int desiredWidth = specWidthSize;
        final int desiredHeight = specHeightSize - getPaddingTop() - getPaddingBottom();
