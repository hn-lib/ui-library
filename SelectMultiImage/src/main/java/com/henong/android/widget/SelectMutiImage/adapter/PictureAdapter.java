package com.henong.android.widget.SelectMutiImage.adapter;
...
public class PictureAdapter extends BaseAdapter {
	...
	public int getCount() {
		if (SelectBitmapUtil.tempSelectBitmap.size() == 9) {
			return 9;
		}
		return (SelectBitmapUtil.tempSelectBitmap.size() + 1);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (position == SelectBitmapUtil.tempSelectBitmap.size()) {
			...
			holder.image.setImageBitmap(SelectBitmapUtil.tempSelectBitmap.get(
					position).getBitmap());
		}
